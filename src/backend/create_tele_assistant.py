...
from tele_config.tools.settings import tools_list
from tele_config.tools.settings import assistant_name
from tele_config.tools.settings import func_list
...
def create_app_assistant() -> any:
    prompt_file = "tele_config/prompts/prompt.txt"
    data_folder = "tele_config/data"
